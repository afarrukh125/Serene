...
class StatisticsRepositoryTest {
    ...
    public void testSimpleTranslation() {
        ...
        assertThat(statisticsRepository.getStatisticForString(DeathStatistic.MAIN_NAME).translateToReadableValue(5.)).isEqualTo(5.);
    }
    ...
    public void testTimePlayed() {
        ...
        assertThat(timePlayed.translateToReadableValue(2376000)).isEqualTo(33);
    }
